...
export default function DashboardLayout({
  ...
  return (
    <SidebarProvider defaultOpen={true}>
      <div className="flex w-full min-h-screen bg-gradient-to-b from-blue-100 to-blue-300">
        <Sidebar>
          <SidebarHeader>
        ...
        <div className="flex-1 p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-2 border-blue-700">
              ...
              <h1 className="text-xl font-bold text-blue-700 pr-3">
                {user.name}
              </h1>
              {/* <h2 className="text-sm font-bold text-blue-700 pr-3">
                ({user.role} {user.id})
              </h2> */}
              {/* <SidebarTrigger /> */}
              <Button
